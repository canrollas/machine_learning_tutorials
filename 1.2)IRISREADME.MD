# 1.2) IRIS DATA SET AND INTRO

- In this Lecture I will use sample data set used in ML basics.
- Data set is IRIS data set.
- It based on measurements of flower's iris types.
- It has 4 type of data and outcome which is type of flower:
  - Sepal width (cm)
  - Sepal Length (cm)
  - Petal width (cm)
  - Petal Length (cm)
  - target
    ...
    - 1 : Versicolor
    - 2 : Virginica
- Basically this program will predict the type of flower according to iris data.
- KNN algorithm (Classification) is used in this program.
